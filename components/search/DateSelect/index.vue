...
const dates = computed(() => {
  ...
  const daysCountBetweenNowAndSelected = daysCountBetween(new Date(dateFull.value.date.date), new Date());
...
const submit = async () => {
  props.onSelectDate(setDate(new Date(dateFull.value.date.date)));
