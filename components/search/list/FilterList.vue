...
>
  ...
  const handleFilterBtn = () => { isOpened.value = false; };
...
<template>
  <div class="">
    ...
    <transition name="slide-up">
      <div
        v-if="isOpened"
        class="px-[20px] py-[30px] absolute top-[70px] right-0 z-50 border border-white bg-dark max-[542px]:px-2 max-[542px]:py-[20px] max-[542px]:left-0 max-[542px]:w-full"
      >
        <div class="w-[500px] max-[542px]:w-full">
            ...
            <div class="grid grid-cols-3">
              ...
              >
                <img
                  ...
                  alt="type-fly-img"
                />
                <span class="text-18 c-hover group-hover:text-orange max-[542px]:text-[14px]">{{ type.label }}</span>
              </button>
            </div>
          </div>
